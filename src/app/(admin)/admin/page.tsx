    ...
    <div className="space-y-8">
      <header>
        ...
        <p className="text-sm text-muted-foreground">
          Resumen rápido de tu verdulería.
        </p>
      </header>

      <ul className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Stat label="Pendientes" value={pendingCount ?? 0} href="/admin/pedidos?status=pending" />
        <Stat label="Pedidos hoy" value={todayCount ?? 0} href="/admin/pedidos" />
        <Stat label="Productos activos" value={productCount ?? 0} href="/admin/productos" />
        <Stat label="Repartidores" value={driverCount ?? 0} href="/admin/repartidores" />
      </ul>
